   ...
   public partial class DeliveryOptionController
   {
      ...
      public async Task<IActionResult> Put([FromBody] DeliveryOption modifiedDeliveryOption)
      {
         try
         {
            ...
            DeliveryOption currentDeliveryOption = await _unitOfWork.DeliveryOptions
                .FindAsync(modifiedDeliveryOption.Id)
            ...
            if (await _unitOfWork.DeliveryOptions
            ...
            _unitOfWork.DeliveryOptions.Modify(currentDeliveryOption);
