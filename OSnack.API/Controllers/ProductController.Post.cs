   ...
   public partial class ProductController
   {
      ...
      public async Task<IActionResult> Post([FromBody] Product newProduct)
      {
         try
         {
            ...
            if (await _unitOfWork.Products.AnyAsync(d => d.Name == newProduct.Name && d.Category.Id == newProduct.Category.Id).ConfigureAwait(false))
            {
            ...
            try
            {
               await _unitOfWork.Products.AddProductAsync(newProduct).ConfigureAwait(false);
