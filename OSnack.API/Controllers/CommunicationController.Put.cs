...
namespace OSnack.API.Controllers
{
   public partial class CommunicationController
   {
      ...
      private async Task<IActionResult> Update(string communicationId, bool isCustomer, Message message, bool status = false)
      {
         try
         {
            var originalCommunication = await _unitOfWork.Communications
               .GetCommunicationOrDisputeWithMessages(communicationId);
            ...
            _unitOfWork.Communications.Modify(originalCommunication);
