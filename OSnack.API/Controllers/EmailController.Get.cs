...
namespace OSnack.API.Controllers
{
   public partial class EmailController
   {
      ...
      public async Task<IActionResult> AllTemplate()
      {
         try
         {
            List<EmailTemplate> templateList = await _unitOfWork.EmailTemplates
               .GetAllEmailTemplateOrderByTemplateType()
      ...
      public async Task<IActionResult> GetTemplate(int templateId)
      {
         try
         {
            var defaultTemplate = await _unitOfWork.EmailTemplates
      ...
      public async Task<IActionResult> GetAllAvailableTemplateTypes()
      {
         try
         {
            var typeList = Enum.GetValues(typeof(EmailTemplateTypes)).Cast<EmailTemplateTypes>().ToList();
            foreach (var item in await _unitOfWork.EmailTemplates.GetAllAsync())
            {
