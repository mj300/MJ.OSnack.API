...
namespace OSnack.API.Controllers
{
   public partial class NewsletterController
   {
      ...
      public async Task<IActionResult> Post([FromBody] Newsletter newsletter)
      {
         try
         {
            if (await _unitOfWork.Newsletters.FindAsync(newsletter.Email).ConfigureAwait(false) != null)
            ...
            await _unitOfWork.Newsletters.AddAsync(newsletter).ConfigureAwait(false);
